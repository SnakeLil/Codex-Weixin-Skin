...
ENGINE="${CODEX_WEIXIN_SKIN_ENGINE:-$HOME/.codex/codex-weixin-skin-studio}"
...
START="$SCRIPTS/start-weixin-skin-macos.sh"
PAUSE="$SCRIPTS/pause-weixin-skin-macos.sh"
CUSTOMIZE="$SCRIPTS/customize-theme-macos.sh"
RESTORE="$SCRIPTS/restore-weixin-skin-macos.sh"
STATUS="$SCRIPTS/status-weixin-skin-macos.sh"
