...
const name = validateText(valueFor("name", "我的 Codex WeChat Skin"), "name", 80, "我的 Codex WeChat Skin");
...
const custom = {
  schemaVersion: 1,
  id: `custom-${Date.now()}`,
  name: name || "我的 Codex WeChat Skin",
  brandSubtitle: "CODEX WEIXIN SKIN",
  tagline: tagline || "把 Codex 变成你熟悉的微信聊天界面。",
  projectPrefix: "选择项目 · ",
  projectLabel: "◉  选择项目",
  statusText: "WEIXIN SKIN ONLINE",
